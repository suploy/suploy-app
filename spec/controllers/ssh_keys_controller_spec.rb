...
describe Api::Users::SshKeysController do
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new SshKey" do
        expect {
          post :create, {:ssh_key => valid_attributes}, valid_session
      ...
      it "redirects to the created ssh_key" do
        post :create, {:ssh_key => valid_attributes}, valid_session
        response.should redirect_to(SshKey.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved ssh_key as @ssh_key" do
        ...
        post :create, {:ssh_key => { "title" => nil }}, valid_session
        assigns(:ssh_key).should be_a_new(SshKey)
      end
    end
  end
  ...
  describe "DELETE destroy" do
    it "destroys the requested ssh_key" do
      ssh_key = SshKey.create! valid_attributes
      expect {
        delete :destroy, {:id => ssh_key.to_param}, valid_session
      }.to change(SshKey, :count).by(-1)
    end
    ...
    it "redirects to the ssh_keys list" do
      ssh_key = SshKey.create! valid_attributes
      delete :destroy, {:id => ssh_key.to_param}, valid_session
      response.should redirect_to(ssh_keys_url)
    end
  end
